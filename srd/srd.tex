...
\subsubsubsection{Améliorer les bâtiments}
\begin{description}
...
\end{description}
\subsubsubsection{Améliorer l'équipement}
\begin{description}
...
\subsubsubsection{S'inscrire en tournoi}
\begin{description}
...
\subsubsubsection{Participer à un match du tournoi}
\begin{description}
...
\subsubsubsection{Voir la liste des participants d'un tournoi}
\begin{description}
\item[Action] L'\gls{utilisateur} doit pouvoir voir la liste des participants d'un tournoi lancé ou terminé.
\item[Requiert] L'\gls{utilisateur} doit être connecté.
\subsubsubsection{Voir l'historique d'un tournoi}
...
%%RAJOUTER UNE subsubsubsection ICI AVEC QUELQUES INFO SUR LE JEU
\subsubsubsection{Déclarer forfait}
\begin{description}
...
\subsubsection{Identification}
\subsubsubsection{Enregistrer une inscription}
\begin{description}
...
\subsubsubsection{Fournir une interface}
\begin{description}
...
\subsubsubsection{Représenter phase management}
\begin{description}
...
\subsubsubsection{Représenter phase match}
\begin{description}
...
\subsubsubsection{Créer un tournoi}
\begin{description}
...
\subsubsubsection{Mettre à jour un tournoi}
\begin{description}
