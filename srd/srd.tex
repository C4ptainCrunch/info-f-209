...
\begin{description}
\item[Authentification] : L'utilisateur doit pouvoir s'enregistrer et se connecter sur le serveur avec un authentifiant unique et un mot de passe.
\item[Nouvelle carrière] : L'utilisateur doit pouvoir créer une nouvelle partie, lui conférant un nouveau \gls{club} rudimentaire.
