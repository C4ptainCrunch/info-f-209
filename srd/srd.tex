...
\begin{description}
\item[Action] L'\gls{utilisateur} doit pouvoir voir les l'historique d'un tournoi (ce comprenant les tournois terminés et les tournois auquel l'utilisateur ne participe pas ou n'a pas participé), ainsi que la liste des participants pour tout les tournois lancés ou terminés.
\item[Requiert] L'\gls{utilisateur} doit être connecté.
\end{description}
