...
Durant sa création, il fixera une date limite pour les inscriptions. Une fois la limite passée, le tournoi démarre, et le serveur génèrera l'arbre des matches. %Ajouter arbre des matches au gloss? Modifier le nom pour quelque chose de plus beau? utilisateurs au pluriel? ROM1 OSKOUR.
\end{description}
