...
\begin{description}
\item[Cas général] L'\gls{utilisateur} doit pouvoir améliorer ses divers bâtiments sur plusieurs niveaux. Chaque bâtiment aura sa ou ses spécificités, parmi trois :\\
...
\begin{description}
\item[Cas général] L'\gls{utilisateur} doit pouvoir améliorer l'équipement de ses joueurs (bâtons, ...) pour changer leurs caractéristiques.
\item[Pré condition] L'\gls{utilisateur} doit être connecté.
...
\item[Pré condition] L'\gls{utilisateur} doit être connecté.
\item[Pré condition] L'\gls{utilisateur} doit être sélectionné comme étant l'un des deux participant du match.
...
\item[Pré condition] Date limite d'une phase d'inscription.
\end{description}
