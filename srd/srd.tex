...
Ce qui lui permettra d'être sélectionné pour de matchs et d'y affronter les autres joueurs inscrits à ce tournoi. % Je ne suis pas sur que joueurs est bien le bon terme ici
\item[Requiert] L'\gls{utilisateur} doit être connecté.
\end{description} 
...
\begin{itemize}
\item Le jeu doit être multi-joueur, les différents joueurs connectés sur un même \gls{serveur} doivent pourvoir interagir entre eux. % Je pense que ce n'est pas joueur qu'il aurait fallut mettre ici.
