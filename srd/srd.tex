...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{uml/MenuUCD.eps}
...
\subsubsection{Gestion des infrastructures}
    \begin{center}
        \includegraphics[width=\textwidth]{uml/InfrastructuresUCD.eps}
...
\begin{figure}[H]
    %\vspace*{-3cm}
    \makebox[\linewidth]{
        \includegraphics[height=280pt]{uml/generalActivityDiagram.eps}
    }
