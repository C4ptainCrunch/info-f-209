...
\author{Bruno Rocha Poreira \and Jérome Vial 2 \and Cédric Strebelle \and
...
\begin{description}
\item[Action] Le système doit générer et gérer les tournois en ligne, où les \glspl{utilisateur} inscrits devront s'affronter durant des matches organisés dans les stades des \glspl{club}.
\end{description}
