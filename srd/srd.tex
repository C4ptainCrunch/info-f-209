...
\begin{figure}[H]
    %\vspace*{-3cm}
    \makebox[\linewidth]{
        \includegraphics[scale = 0.77]{uml/auctionHouseActivityDiagram.png}
    }
...
\begin{figure}[H]
    %\vspace*{-3cm}
    \makebox[\linewidth]{
        \includegraphics[scale = 0.3]{uml/matchActivityDiagram.png}
    }
...
\begin{figure}[H]
    %\vspace*{-3cm}
    \makebox[\linewidth]{
        \includegraphics[scale = 0.24]{uml/globalActivityDiagram.png}
    }
