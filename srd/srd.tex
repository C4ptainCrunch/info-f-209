...
\fancypagestyle{empty}{%
  ...
  \fancyhead[L]{\includegraphics[scale=0.5]{logoulb.jpg}}% Your logo/image
}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{uml/ConnectionUCD.eps}
...
\begin{itemize}
    ...
    \item Le réseau décrit ci-dessus doit pourvoir une latence raisonnablement faible (c'est à dire moins de 500ms pour un aller retour) et dispoer du port 9000/tcp ouvert en sortie pour le serveur et en entrée pour le client.
...
\begin{figure}[H]
    \vspace*{-3cm}
    \makebox[\linewidth]{
        \includegraphics[scale = 0.4]{uml/generalClassDiagram.png}
    }
...
\begin{figure}[H]
    %\vspace*{-3cm}
    \makebox[\linewidth]{
        \includegraphics[width=\textwidth]{uml/matchActivityDiagram.eps}
    }
...
\begin{figure}[H]
    %\vspace*{-3cm}
    \makebox[\linewidth]{
        \includegraphics[scale = 0.24]{uml/globalActivityDiagram.eps}
    }
...
%    %\vspace*{-3cm}
%    \makebox[\linewidth]{
%        \includegraphics[scale = 0.50]{uml/DiagrammeComposantsModels.png}
%    }
...
%    %\vspace*{-3cm}
%    \makebox[\linewidth]{
%        \includegraphics[scale = 0.50]{uml/DiagrammeComposantsServer.png}
%    }
...
%    %\vspace*{-3cm}
%    \makebox[\linewidth]{
%        \includegraphics[scale = 0.50]{uml/DiagrammeComposantsViews.png}
%    }
