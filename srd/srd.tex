...
\section{Besoin d'utilisation}
	\subsection{Exigences fonctionnelles}
		\begin{description}[style=nextline]
			\item[Inscription :]
			\begin{description}[leftmargin=*] %USR Inscription
				\item[]
			...
			\end{description} %USR Inscription
			
			\item[Connection :]
			\begin{description}[leftmargin=*] %USR Connection
				\item[]
			...
			\end{description} %USR Connection
			
			\item[Management :]
			\begin{description}[leftmargin=*] %USR Management
				\item[]
			...
			\end{description} %USR Management
			
			\item[Tournois :]
			\begin{description}[leftmargin=*] %USR Tournois
				\item[]
...
\section{Besoin du système}
	\subsection{Exigences fonctionnelles}
		\begin{description}[style=nextline]
			...
			\begin{description}[leftmargin=*] %SYS Vérification d'authentification
				\item[]
			...
			\end{description} %SYS Vérification d'authentification
			
			\item[Interface :]
			\begin{description}[leftmargin=*] %SYS Interface
				\item[]
			...
			\end{description} %SYS Interface
			
			\item[Représentation phase management :]
			\begin{description}[leftmargin=*] %SYS Représentation phase management
				\item[]
			...
			\end{description} %SYS Représentation phase management
			
			\item[Représentation phase match :]
			\begin{description}[leftmargin=*] %SYS Représentation phase match
				\item[]
			...
			\end{description} %SYS Représentation phase match
			
			\item[Sauvegarde :]
			\begin{description}[leftmargin=*] %SYS Sauvegarde
				\item[]
			...
			\end{description} %SYS Sauvegarde
			
			\item[Tournois :]
			\begin{description}[leftmargin=*] %SYS Tournois
				\item[]
