...
\item[Enregistrer :]
\begin{description} %SYS Enregistrer
...
\item[Authentifier :]
\begin{description} %SYS Authentifier
...
\begin{description} %SYS Fournir une interface
...
\begin{description} %SYS Représenter phase management
...
\begin{description} %SYS Représenter phase match
...
\item[Sauvegarder :]
\begin{description} %SYS Sauvegarder
...
\begin{description} %SYS Gérer les tournois
